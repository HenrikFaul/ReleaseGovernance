...
export const globalNavItems: GlobalNavItem[] = [
  { key: "portfolio", label: "Portfolio", href: "/portfolio", description: "Workspace and portfolio-level governance overview" },
  { key: "projects", label: "Projects", href: "/projects", description: "Project registry and onboarding entry" },
];
