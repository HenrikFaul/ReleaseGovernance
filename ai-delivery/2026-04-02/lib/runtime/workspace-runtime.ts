...
import type { WorkspaceFixtureBundle, ProjectFixtureBundle } from "../fixtures/workspace-fixtures";
...
export function workspaceFixtureToRuntimeAggregate(bundle: WorkspaceFixtureBundle): RuntimeWorkspaceAggregate {
  return {
...
export function projectFixtureToRuntimeAggregate(fixture: ProjectFixtureBundle): RuntimeProjectAggregate {
  return {
