...
export function AppShell({ children, projectId }: AppShellProps) {
  ...
  const projectNav: NavItem[] = projectId
    ? [
        ...
        { href: `/projects/${projectId}/capabilities`, label: "Capabilities", shortLabel: "Capabilities" },
        { href: `/projects/${projectId}/integrations`, label: "Integrations", shortLabel: "Integrations" },
